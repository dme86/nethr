...
- World density can be tuned at build time, e.g.:
  ...
  - `make build EXTRA_CPPFLAGS="-DWORLDGEN_PLAINS_TREE_BASE_CHANCE=28 -DWORLDGEN_PLAINS_TREE_PATCH_BONUS=120 -DWORLDGEN_PUMPKIN_PATCH_THRESHOLD=80 -DWORLDGEN_FLOWER_PATCH_THRESHOLD=62"`
  - `make build EXTRA_CPPFLAGS="-DWORLDGEN_SWAMP_TREE_BASE_CHANCE=64 -DWORLDGEN_SWAMP_TREE_PATCH_BONUS=140 -DWORLDGEN_SWAMP_MUSHROOM_CHANCE=24 -DWORLDGEN_DESERT_CACTUS_FLOWER_CHANCE=20"`
  - `make build EXTRA_CPPFLAGS="-DWORLDGEN_SNOWY_TREE_BASE_CHANCE=40 -DWORLDGEN_SNOWY_MUSHROOM_CHANCE=8 -DWORLDGEN_PLAINS_MUSHROOM_CHANCE=5"`
